...
return [
    ...
    */
    ...
    'date_equals'          => 'attributeにはdateより後の日付を指定してください',
    ...
    'ends_with'            => 'The :attributeには:valuesのうちいづれかの値を指定してください。',
    ...
    'gt'                   => [
        ...
        'string'  => ':attribute は:value文字より多い必要があります。',
        'array'   => ':attribute には:value個より多くの項目が必要です。',
    ],
    'gte'                  => [
        'numeric' => ':attribute は:value以上である必要があります。',
        'file'    => ':attribute は:valueキロバイト以上である必要があります。',
        'string'  => ':attribute は:value文字以上である必要があります。',
        'array'   => ':attribute には:value個以上の項目が必要です。',
    ],
    ...
    'not_regex'            => 'The :attributeの形式が無効です。.',
    'numeric'              => ':attributeには数値を指定してください。',
    'present'              => ':attributeには現在時刻を指定してください。',
    'regex'                => ':attributeは半角英数字の組み合わせで指定してください。',
    ...
    'starts_with'          => ':attributeは:valuesのいづれかから開始する必要があります。',
